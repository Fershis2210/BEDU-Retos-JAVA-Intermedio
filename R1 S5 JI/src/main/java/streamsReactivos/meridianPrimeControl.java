...
public class meridianPrimeControl {
    public static void main(String[] args) throws InterruptedException {
        ...
        Flux<Integer> trafico = Flux.interval(Duration.ofMillis(500))
                ...
                .doOnNext(congestion -> System.out.println("Alerta: Congestión del " + congestion + "% en Avenida México"))
        ...
        Flux<Integer> trenes = Flux.interval(Duration.ofMillis(700))
                ...
                .doOnNext(retraso -> System.out.println("Tren con retraso crítico: " + retraso + " minutos."))
    ...
    private static Flux<String> controlarSemaforos (Flux<String> flujo) {
        ...
        return flujo
                ...
                .doOnNext(estado -> System.out.println("Semáforo en rojo detectado 3 veces seguidas en cruce Centro"));
    }
}
