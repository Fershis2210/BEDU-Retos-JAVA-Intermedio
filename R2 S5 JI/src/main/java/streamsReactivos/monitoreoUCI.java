...
public class monitoreoUCI {
    public static void main(String[] args) throws InterruptedException {
        ...
        Flux<eventoVital> paciente1 = signosVitales(1, random);
        Flux<eventoVital> paciente2 = signosVitales(2, random);
        Flux<eventoVital> paciente3 = signosVitales(3, random);

        Flux.merge(paciente1, paciente2, paciente3)
                .filter(eventoVital::estadoCritico)
    ...
    private static Flux<eventoVital> signosVitales(int pacienteId, Random random) {
    ...
    static class eventoVital {
        ...
        public String toString() {
            ...
            if (fc < 50 || fc > 120)
                sb.append("Paciente ").append(pacienteId).append(" - FC crítica: ").append(fc).append(" bpm\n");
            if (spo2 < 90)
                sb.append("Paciente ").append(pacienteId).append(" - SpO2 baja: ").append(spo2).append("%\n");
